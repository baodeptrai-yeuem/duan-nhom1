...
=======
<<<<<<< HEAD
                                <span>Tạm tính</span><span class="right"><?= number_format($_SESSION['totalPrice'], 3, '.', ',') ?>đ</span>
=======
                                <span>Tạm tính</span><span class="right"><?= $_SESSION['totalPrice'] ?></span>
...
=======
<<<<<<< HEAD
                                <span>Tổng cộng</span><span class="right" id="total_price"><?= number_format($_SESSION['totalPrice'], 3, '.', ',') ?>đ</span>
=======
                                <span>Tổng cộng</span><span class="right" id="total_price"><?= $_SESSION['totalPrice'] ?></span>
>>>>>>> b334f948a9b2bc2245904cb16bc6c775ccc15bb3
>>>>>>> eb70c47 (Trang Đơn hàng của tôi + chi tiết đơn hàng)
...
<<<<<<< HEAD
            ...
            window.alert('Cảm ơn bạn đã mua hàng tại shop tôi');
=======
            localStorage.removeItem('cartItems');
>>>>>>> b334f948a9b2bc2245904cb16bc6c775ccc15bb3
>>>>>>> eb70c47 (Trang Đơn hàng của tôi + chi tiết đơn hàng)
